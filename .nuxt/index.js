...
import nuxt_plugin_plugin_137dc662 from 'nuxt_plugin_plugin_137dc662' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_image_53381d1a from 'nuxt_plugin_image_53381d1a' // Source: ./image.js (mode: 'all')
import nuxt_plugin_recaptcha_25aa86e7 from 'nuxt_plugin_recaptcha_25aa86e7' // Source: ./recaptcha.js (mode: 'all')
import nuxt_plugin_axios_29461710 from 'nuxt_plugin_axios_29461710' // Source: ./axios.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"web","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"},{"hid":"theme-color","name":"theme-color","content":"#E12328"}],"link":[{"rel":"shortcut icon","type":"image\u002Fsvg+xml","href":"\u002Flogo.svg"},{"rel":"apple-touch-icon","type":"image\u002Fsvg+xml","href":"\u002Flogo.svg"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_137dc662 === 'function') {
    await nuxt_plugin_plugin_137dc662(app.context, inject)
  }

  if (typeof nuxt_plugin_image_53381d1a === 'function') {
    await nuxt_plugin_image_53381d1a(app.context, inject)
  }

  if (typeof nuxt_plugin_recaptcha_25aa86e7 === 'function') {
    await nuxt_plugin_recaptcha_25aa86e7(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_29461710 === 'function') {
    await nuxt_plugin_axios_29461710(app.context, inject)
  }
